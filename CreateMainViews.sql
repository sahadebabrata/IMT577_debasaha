...
CREATE OR REPLACE VIEW VW_STORE_SALES_TARGET AS
SELECT
...
SELECT * FROM VW_STORE_SALES_TARGET; 

-- VIEW FOR AGGREGATE SALES DATA  
CREATE OR REPLACE VIEW VW_STORE_AGG_SALES_DATA AS
...
--
SELECT * FROM VW_STORE_AGG_SALES_DATA ; 


---VIEW FOR PRODUCT SALES TARGET
CREATE OR REPLACE VIEW VW_STORE_PRODUCT_SALES_TARGET AS
...
ORDER BY dd."YEAR" ;
--
SELECT * FROM VW_STORE_PRODUCT_SALES_TARGET; 


-- VIEW FOR PRODUCT AGGREGATE SALES BY DAY OF WEEK   
CREATE OR REPLACE VIEW VW_STORE_AGG_SALES_BY_DAY AS
...
--
SELECT * FROM VW_STORE_AGG_SALES_BY_DAY; 


-- VIEW FOR PRODUCT SALES DAILY
CREATE OR REPLACE VIEW VW_STORE_SALES_DAILY AS
...
--
SELECT * FROM VW_STORE_SALES_DAILY; 